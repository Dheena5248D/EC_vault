...
Definition upsates need not to be approved every single time if a definition update is approved once it will be approved for upcoming patches too since the new patch will be in same patch id
